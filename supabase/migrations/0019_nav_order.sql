-- Fase 6b (Personalización avanzada) — orden de las pestañas principales.
-- Ver src/domain/types.ts (`Settings.navOrder`), src/domain/navigation.ts (NAV_TABS).

alter table public.user_settings add column nav_order text[];

-- Actualizar save_app_data para incluir nav_order en user_settings.
