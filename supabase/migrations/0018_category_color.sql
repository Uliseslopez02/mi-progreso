-- Fase 6a (Personalización avanzada) — color por categoría.
-- Ver src/domain/types.ts (`Category.color`), src/domain/categoryColors.ts (paleta).

alter table public.categories add column color text;

-- Actualizar save_app_data para incluir color en categories.
